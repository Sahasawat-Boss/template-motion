...
export default function Contact() {
  ...
  return (
    <motion.section
      id="contact"
      ref={ref}
      className="mb-20 mt-20 w-[min(100%,38rem)] scroll-mt-28 text-center sm:mb-28"
      initial={{
        opacity: 0,
      }}
      whileInView={{
    ...
    >
      ...
      <p className="mt-5 text-gray-700 dark:text-white/80">
        Contact via{" "}
        <a className="underline" href="mailto:mail@gmail.com">
        mail@gmail.com
        </a>
        <br />
      ...
      <form
        className="mt-10 flex flex-col items-center justify-center  w-[250px] dark:text-black"
